...
public:
  // Constructors
  Enum(string id, const Location& location, 
  ...
  const Vector<string>& enumList() const { return m_enum_vec;  }
...
ostream& operator<<(ostream& out, const Enum& obj);
